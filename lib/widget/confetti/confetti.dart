...
import 'package:animation_demo/widget/confetti/particle.dart'
    show Particle, ParticleSystem, ParticleSystemStatus;
...
class ConfettiWidget extends StatefulWidget {
  const ConfettiWidget({
    ...
    this.strokeWidth = 0,
    this.minimumSize = const Size(6, 16),
    this.maximumSize = const Size(12, 30),
...
class ParticlePainter extends CustomPainter {
  ...
  void _paintParticles(Canvas canvas) {
    for (final particle in particles) {
      ...
      _particlePaint.shader = const LinearGradient(
          begin: Alignment(-1, 1),
          end: Alignment(1, 1),
          ...
          colors: [
            ...
            Color(0xffd68d24),
            Color(0xffaf812b),
          ]).createShader(finalPath.getBounds());
