...
import 'package:animation_demo/persistent_appbar/persistent_header_page.dart';
  ...
  routes: [
    GoRoute(
      ...
      routes: [
        ...
        GoRoute(
          path: RouteName.persistentHeaderPage,
          name: RouteName.persistentHeaderPage,
          builder: (context, state) {
            return const PersistentHeaderPage();
          },
        ),
      ],
    ),
