...
const Color colorCyan1 = Color(0xeff9ffff);
const Color colorRed = Color(0xffee0000);
const Color colorGreen = Color(0xff7eba2f);
...
const Color colorPayBlack = Color(0xff252525);
const Color colorPayBlue = Color(0xff0078f7);
const Color colorPayBlue100 = Color(0xff8fbcff);
const Color colorPayBlue900 = Color(0xff104eda);
const Color colorPayGrey = Color(0xff8e8e8e);
const Color colorPayDimGrey = Color(0xff545454);
const Color colorPayRed = Color(0xffff4444);
