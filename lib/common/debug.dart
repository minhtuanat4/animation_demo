...
class CustomTrace {
  ...
  void _parseTrace() {
    ...
    final _traceString = _trace.toString().split('\n')[0];

    /* Search through the string and find the index of the file name by looking for the '.dart' regex */
    final indexOfFileName = _traceString.indexOf(RegExp(r'[A-Za-z]+.dart'));

    final fileInfo = _traceString.substring(indexOfFileName);
